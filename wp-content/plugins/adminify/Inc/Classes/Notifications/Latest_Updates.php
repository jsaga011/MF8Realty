	...
	class Latest_Updates extends Notice
	{
		...
		public function notice_content()
		{
			$jltwp_adminify_changelog_message = sprintf(
				...
				__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Avia Page Builder </span><br>', 'adminify'),
				__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Security issue fixed </span><br>', 'adminify'),
				__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Slow Admin issue improved </span><br>', 'adminify'),
				...
				__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Latest WordPress 6.4.1 Compatibility </span><br>', 'adminify')
			);
